export const config = {
    ...
    bank: {
        account1: {
            bankName: process.env.NEXT_PUBLIC_BANK_1_NAME || "",
            accountName: process.env.NEXT_PUBLIC_BANK_1_ACCOUNT_NAME || "",
            accountNumber: process.env.NEXT_PUBLIC_BANK_1_ACCOUNT_NUMBER || "",
        },
        account2: {
            bankName: process.env.NEXT_PUBLIC_BANK_2_NAME || "",
            accountName: process.env.NEXT_PUBLIC_BANK_2_ACCOUNT_NAME || "",
            accountNumber: process.env.NEXT_PUBLIC_BANK_2_ACCOUNT_NUMBER || "",
        },
    },
};
